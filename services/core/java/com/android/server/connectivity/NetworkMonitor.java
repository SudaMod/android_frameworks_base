...
public class NetworkMonitor extends StateMachine {
    ...
    private String getCaptivePortalServerHttpsUrl() {
        return mSettings.getSetting(mContext,
                Settings.Global.CAPTIVE_PORTAL_HTTPS_URL, isChinese() ? DEFAULT_HTTPS_URL_CN : DEFAULT_HTTPS_URL);
    }
    ...
    public static String getCaptivePortalServerHttpUrl(
        ...
        return settings.getSetting(
                context, Settings.Global.CAPTIVE_PORTAL_HTTP_URL, isChinese() ? DEFAULT_HTTP_URL_CN : DEFAULT_HTTP_URL);
    }
