...
public class NightModeTile extends QSTile<QSTile.BooleanState> {
    ...
    private NightModeObserver mObserver;

    public NightModeTile(Host host) {
        super(host);
        mObserver = new NightModeObserver(mHandler);
    }
    ...
    private class NightModeObserver extends ContentObserver {
        ...
        public void startObserving() {
            mContext.getContentResolver().registerContentObserver(
                    Settings.Global.getUriFor(Settings.Global.NIGHT_MODE),
                    false, this);
        }
