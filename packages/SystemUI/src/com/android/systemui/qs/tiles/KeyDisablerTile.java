...
public class KeyDisablerTile extends QSTile<QSTile.BooleanState> {
    ...
    public boolean isAvailable() {
        return CMHardwareManager.getInstance(mContext)
    ...
    protected void handleClick() {
        ...
        if (isNavigationBarShown()) {
            ...
            mState.value = !hardware.get(CMHardwareManager.FEATURE_KEY_DISABLE);
            MetricsLogger.action(mContext, getMetricsCategory(), mState.value);
            hardware.set(CMHardwareManager.FEATURE_KEY_DISABLE, mState.value);
    ...
    public Intent getLongClickIntent() {
        return new Intent("org.cyanogenmod.cmparts.BUTTON_SETTINGS");
    }
