...
public class Constant {
    ...
    public static final String[] SPEC_DAY_CN = {"5,2,0,母情节", "6,3,0,父亲节", "11,4,4,感恩节"};
    public static final String[] SPEC_DAY_HK = {"5,2,0,母情節", "6,3,0,父親節", "11,4,4,感恩節"};
    public static final String[] SPEC_DAY_TW = {"5,2,0,母情節", "11,4,4,感恩節"};
